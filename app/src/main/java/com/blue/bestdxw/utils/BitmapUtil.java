        ...
        if(bitmap != null && !bitmap.isRecycled()) {
            try {
                ...
                if(byteArrayOutputStream.toByteArray() == null) {
                    LogUtil.d(TAG, "bitmap2Bytes byteArrayOutputStream toByteArray=null");
                }
                return byteArrayOutputStream.toByteArray();
            } catch (Exception e) {
                LogUtil.d(TAG, "bitmap2Bytes exception");
            } finally {
            ...
            LogUtil.d(TAG, "bitmap2Bytes bitmap == null or bitmap.isRecycled()");
            return null;
        }
    }
        ...
        if(datas != null && datas.length > byteCount) {
            ...
            if(outputStream != null) {
                ...
                if(outputStreamByte.length > byteCount) {
                    LogUtil.d(TAG, "compressBitmap cannot compress to " + byteCount + ", after compress size=" + outputStreamByte.length);
                }
